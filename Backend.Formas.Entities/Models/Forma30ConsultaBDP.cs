...
{
    public class Forma30ConsultaBDP
    {
        ...
        public List<string> CONTRATO_ID { get; set; }
        public string CONTRATO { get; set; }
        public string CAMPO_ID { get; set; }
        public string CAMPO { get; set; }
        public List<string> BATERIA_ID { get; set; }
        public List<string> BATERIA { get; set; }
        public List<string> TANQUE_ID { get; set; }
        public List<string> TANQUE { get; set; }
        public List<string> ESTRUCTURA_ID { get; set; }
        public List<string> ESTRUCTURA { get; set; }
        public List<string> BLOQUE_ID { get; set; }
        public List<string> BLOQUE { get; set; }
        public List<string> FORMACION_ID { get; set; }
        public List<string> FORMACION_SET_ID { get; set; }
        public string FORMACION { get; set; }
        public List<string> MIEMBRO_ID { get; set; }
        public List<string> MIEMBRO { get; set; }
        public List<string> YACIMIENTO_ID { get; set; }
        public List<string> YACIMIENTO { get; set; }
        public List<string> MODALIDADEXPLOTACION_ID { get; set; }
