...
{
    public class HeaderForma9MasivaDTO
    { /// <summary>
      /// MCG  --- > Mejoras BDP ++ 
      /// 2022 - Feb - 15
      ...
      /// </summary>
        ...
        public string UsuarioAprobador { set; get; }    // Uasuari que aprueba para aprobaciones 
        public string UsuarioMin { set; get; }          // Campo de compaibilidad
