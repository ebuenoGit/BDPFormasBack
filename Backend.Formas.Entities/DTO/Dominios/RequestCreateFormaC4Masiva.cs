...
{
    public class RequestCreateFormaC4Masiva
    {   /// <summary>
        /// MCG  --- > Mejoras BDP ++ 
        /// 2022 - Feb - 15
        ...
        public HeaderFormaC4MasivaDTO HeaderC4Masiva { set; get; }
        public List<DetalleJsonC4Masiva> DetailC4Multiple{ set; get; }
        public List<DetalleJsonC4Masiva> DetaSaveBDP { set; get; }
        public List<DetalleJsonC4Municipio> DetaSaveMuni { set; get; }
    }
}
