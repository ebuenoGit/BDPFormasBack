...
{
    public class Detalle22Aprobacion
    {
        ...
        public string WATER_VOLUME_INY { set; get; }
        public string WATER_CUM_VOLUME_INY { set; get; }
        public string WATER_VOLUME_PRO { set; get; }
        public string WATER_CUM_VOLUME_PRO { set; get; }
        public string GAS_VOLUME_INY { set; get; }
        public string GAS_CUM_VOLUME_INY { set; get; }
        public string GAS_VOLUME_PRO { set; get; }
        public string GAS_CUM_VOLUME_PRO { set; get; }
