namespace Backend.Formas.Entities.DTOI
{
    public class DetailForm9
    {
        ...
        public string PERIOD_ON_PRODUCTION_UOM { set; get; }
        public string OIL_VOLUME { set; get; }
        public string OIL_CUM_VOLUME { set; get; }
        public string ECP_CORRECTION_FACTOR { set; get; }
        public string GAS_VOLUME { set; get; }
        public string GAS_CUM_VOLUME { set; get; }
        public string WATER_VOLUME { set; get; }
        public string WATER_CUM_VOLUME { set; get; }
        public string ECP_BSW { set; get; }
        public string OIL_QUALITY { set; get; }
        public string ECP_GOR { set; get; }
